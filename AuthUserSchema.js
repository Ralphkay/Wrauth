...
const AuthUserSchema = function(options={}){
   ...
   const authschem = new mongoose.Schema({
        ...
        deletionMechanism:{
            softDeletion:{type:Boolean, required: true, default:options.deletionMechanism.softDeletion},
            legacyDeletion:{type:Boolean,required:true, default: options.deletionMechanism.legacyDeletion}
        },
